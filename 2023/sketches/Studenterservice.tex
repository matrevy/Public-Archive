...
\begin{roles}
\role{XS1}[Stine] Instruktør / Legeglad studenterservice
\role{S2}[Sommer] Legeglad studenterservice
\role{Std1}[Louise] Studerende der ringer (CBS'er der skal have merit)
\role{Std2}[Thais] Studerende der ringer (Problemer med KU-mail)
\role{Std3}[Simone] Rus/Studerende der ringer (Ked af det)
\end{roles}
